...
describe('Config section header parity', () => {
  ...
  test('sectionHeaders element count matches CONFIG_HEADER_MAP_ length (79)', () => {
  ...
  test('CONFIG_HEADER_MAP_ has exactly 79 entries', () => {
    expect(CONFIG_HEADER_MAP_.length).toBe(79);
  });
});
