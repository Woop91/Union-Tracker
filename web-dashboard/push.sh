#!/bin/bash
# ═══════════════════════════════════════════════
# PUSH SCRIPT — Web Dashboard to MULTIPLE-SCRIPS-REPO
# Run this in your local terminal (PowerShell or Git Bash)
# ═══════════════════════════════════════════════

REPO_DIR="$HOME/Documents/MULTIPLE-SCRIPS-REPO"
...
cd "$REPO_DIR" || {
  ...
  echo "Clone it first: git clone https://github.com/Woop91/MULTIPLE-SCRIPS-REPO.git $REPO_DIR"
  exit 1
}
...
echo "  https://github.com/Woop91/MULTIPLE-SCRIPS-REPO/tree/$BRANCH"
