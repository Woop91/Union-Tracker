...
// ═══════════════════════════════════════
// POMS REFERENCE DATA — EXCLUDED FROM SOLIDBASE
// ═══════════════════════════════════════
// The full POMS reference dataset is org-specific and excluded from SolidBase.
// This stub preserves the function signature so callers don't break.

/**
 * Returns the POMS reference database for the client-side search tool.
 * Stub — POMS reference data is excluded from SolidBase builds.
 * @param {string} sessionToken
 * @returns {Array} Empty array (feature not available)
 */
...
// Original POMS reference data removed for SolidBase — see DDS repo for full dataset.
