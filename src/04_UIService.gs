 ...
 * Consolidated refresh function (v4.3.9)
 */
...
// resetToDefaultTheme() - REMOVED DUPLICATE - see line 685 for main definition
 ...
 * @deprecated v4.3.9 - DUPLICATE: Primary function is in 02_MemberManager.gs:336
 */
function generateMissingMemberIDs_UIService_DEPRECATED() {
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var sheet = ss.getSheetByName(SHEETS.MEMBER_DIR);
 ...
 * @deprecated v4.3.9 - DUPLICATE: Primary function is in 02_MemberManager.gs:398
 */
function checkDuplicateMemberIDs_UIService_DEPRECATED() {
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var sheet = ss.getSheetByName(SHEETS.MEMBER_DIR);
