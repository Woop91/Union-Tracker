...
var CONFIG_COLS = {
  ...
  // ── MOBILE & RESOURCES ── (AZ-BA)
  MOBILE_DASHBOARD_URL: 52,   // AZ - Mobile Dashboard URL (auto-generated by addMobileDashboardLinkToConfig)
  CONTRACT_PDF_URL: 53,       // BA - URL to union contract PDF (Google Drive or external link)

  // ── THEME SETTINGS ── (BB-BG)
  THEME_ENABLED: 54,          // BB - Enable custom theme (Yes/No)
  THEME_HEADER_BG: 55,        // BC - Header background color (hex, e.g., #1e293b)
  THEME_HEADER_TEXT: 56,      // BD - Header text color (hex, e.g., #ffffff)
  THEME_ALT_ROW: 57,          // BE - Alternating row color (hex, e.g., #f8fafc)
  THEME_FONT: 58,             // BF - Font family (e.g., Roboto, Arial)
  THEME_FONT_SIZE: 59         // BG - Font size (number, e.g., 10)
};
