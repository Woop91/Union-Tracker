 ...
 * by createResourcesSheet(). Adds sample union-specific content including
...
function seedResourcesData() {
  ...
  var additionalResources = [
    ...
    ['RES-' + String(nextId++).padStart(3, '0'), 'Collective Bargaining Agreement Summary', 'Contract Article',
      'Key provisions of the current collective bargaining agreement between your union and the agency.',
