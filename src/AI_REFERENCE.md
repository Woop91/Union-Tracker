...
| 2026-03-23 | Claude Code (Opus 4.6) | Full sync from upstream: v1.2.0 Member Hub fully integrated into live app — nav tab, route switch, style/script includes in index.html. hsl-to-hex email fix (bulletproof button pattern) synced to 19_WebDashAuth.gs. Quote pool updated. | `index.html`, `auth_view.html`, `auth_manifesto.html`, `member_hub_styles.html`, `19_WebDashAuth.gs`, `AI_REFERENCE.md` |
