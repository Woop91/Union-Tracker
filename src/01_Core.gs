 ...
 * Example: "Local 123" → "Local 123 Dashboard"
 ...
 * @private
 * @returns {string} Organization name (e.g., "Local 123")
 */
 ...
 *
 * SOURCE: Sample CBA defaults — customize via Config sheet deadline rules.
 * These are fallback values when no Config sheet overrides are set.
 *
