 ...
 * Example: "the union" → "the union Dashboard"
 ...
 * @private
 * @returns {string} Organization name (e.g., "Your Union")
 */
...
var VERSION_INFO = (function() {
  var ver = (typeof COMMAND_CONFIG !== 'undefined' && COMMAND_CONFIG.VERSION) ? COMMAND_CONFIG.VERSION : '4.44.0';
  var parts = ver.split('.');
  return {
    version: ver,
 ...
 *
 * SOURCE: the union Unit 8 CBA (2024–2026), Article 23 / MA DOC Grievance
