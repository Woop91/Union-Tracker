 ...
 * @private
 * @returns {string} Organization name (e.g., "My Union")
 */
...
var VERSION_INFO = (function() {
  var ver = (typeof COMMAND_CONFIG !== 'undefined' && COMMAND_CONFIG.VERSION) ? COMMAND_CONFIG.VERSION : '4.34.1';
  var parts = ver.split('.');
  return {
    version: ver,
 ...
 *
 * SOURCE: Sample CBA deadline rules. Actual values are loaded from Config sheet
 * at runtime via getDeadlineRules().
 *
