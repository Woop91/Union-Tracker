 ...
 */
var VERSION_HISTORY = [
  { version: '4.24.8', date: '2026-03-08', codename: 'POMS Smart Search Integration', changes: 'Added POMS Reference as shared tab (steward + member). 78 sections, 17 flowcharts, search, ratings, bookmarks, notes. Lazy-loaded via getPOMSReferenceHtml(). Synced from DDS Main.' },
