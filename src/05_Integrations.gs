 ...
 * DDS keeps ?page=workload for the standalone PIN-auth portal.
 */
function doGet(e) {
  e = e || { parameter: {} };
  ...
  var legacyPages = ['search', 'grievances', 'members', 'links',
                     'selfservice', 'checkin', 'workload', 'deadlines'];
...
/**
 * Legacy doGet — serves old HTML pages for admin/steward routes and
 * the standalone workload portal. Renamed from doGet in v4.13.0.
 */
