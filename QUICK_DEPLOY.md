...
**9 Modules (~25,339 lines total):**

| # | Module | Lines | Purpose |
|---|--------|-------|---------|
| 01 | Constants.gs | 878 | Sheet names, column mappings, deadline rules |
| 02 | MemberManager.gs | 797 | Member directory operations, form submissions |
| 03 | GrievanceManager.gs | 1,048 | Grievance lifecycle, deadline calculations |
| 04 | UIService.gs | 3,934 | Dialogs, Comfort View, mobile UI |
| 05 | Integrations.gs | 2,098 | Google Drive, Calendar, WebApp, notifications |
| 06 | Maintenance.gs | 2,521 | Diagnostics, caching, data integrity, undo/redo |
| 07 | DevTools.gs | 2,081 | Demo data seeding (**DELETE BEFORE PRODUCTION**) |
| 08 | Code.gs | 11,215 | Core setup, hidden sheets, formulas |
| 09 | Main.gs | 767 | Entry point, onOpen, onEdit triggers |
