...
The codebase follows a layered architecture with 38 modules organized by numbered prefix:
...
| File | Purpose | Key Functions |
|------|---------|---------------|
| `18_WorkloadTracker.gs` | Standalone PIN-auth workload portal (IIFE: WorkloadPortal) | `processWorkloadForm`, `getWorkloadDashboardData` |
...
| `WorkloadTracker.html` | Standalone workload portal UI |
...
Files must be concatenated in dependency order (38 files):
...
const BUILD_ORDER = [
  ...
  '18_WorkloadTracker.gs',        // Standalone PIN-auth workload portal
