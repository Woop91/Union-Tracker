...
## Sync Policy
- **Source of truth:** SolidBase Main
...
- **Exclusions from SolidBase:**
  ...
  - Org-specific references (DDS, Your Organization, Your Union Local) replaced with generic equivalents
...
- Source: SolidBase `195c026` (Main, post-merge)
...
- Org cleanup: All DDS/509/Your Organization refs generalized
