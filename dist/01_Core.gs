...
var CONFIG_HEADER_MAP_ = [
  ...
  { key: 'AUDIT_ARCHIVE_DAYS',       header: 'Audit Log Archive Days' }
];
 ...
 *
 * SOURCE: Union Local Unit 8 CBA (2024–2026), Article 23 / MA DOC Grievance
