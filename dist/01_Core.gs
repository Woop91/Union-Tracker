...
var CONFIG_HEADER_MAP_ = [
  ...
  { key: 'ORG_ABBREV',               header: 'Organization Abbreviation' }
];
 ...
 *
 * SOURCE: Organization CBA, Article 23 / Grievance
