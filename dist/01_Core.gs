...
var VERSION_INFO = (function() {
  var ver = (typeof COMMAND_CONFIG !== 'undefined' && COMMAND_CONFIG.VERSION) ? COMMAND_CONFIG.VERSION : '4.47.0';
  var parts = ver.split('.');
  return {
    version: ver,
    MAJOR: parts.length > 0 ? parseInt(parts[0], 10) : 4,
    MINOR: parts.length > 1 ? parseInt(parts[1], 10) : 45,
 ...
 *
 * SOURCE: Sample CBA grievance timelines / typical state-agency grievance
