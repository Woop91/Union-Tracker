 ...
 * Example: "Your Union" → "Your Union Dashboard"
 ...
 *
 * SOURCE: Configure via Config sheet. Default deadlines based on standard
 * union grievance procedures and collective bargaining agreements.
 *
