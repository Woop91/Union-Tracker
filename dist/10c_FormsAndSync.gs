/**
 * ============================================================================
 * 10c_FormsAndSync.gs — Form Configuration & Sync/Maintenance Utilities
 * ============================================================================
 *
 * Consolidated from 10c_FormHandlers.gs and 10d_SyncAndMaintenance.gs.
 * Contains form configuration objects, refresh helpers, engagement sync
 * functions, and dashboard maintenance utilities.
 *
 * @fileoverview Form configs, sync operations, and maintenance utilities
 * @requires 01_Core.gs
 * @requires 02_DataManagers.gs
 */
...
// ============================================================================
// SYNC & MAINTENANCE (merged from 10d_SyncAndMaintenance.gs)
// ============================================================================
