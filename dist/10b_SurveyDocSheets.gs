...
function createSurveyQuestionsSheet(ss) {
  ...
  var SEED = [
    ...
    ['q81','13','WORKFORCE_RETENTION','Workforce Mobility','Are you currently exploring job opportunities outside the agency?','radio-branch','Y','Y','Yes|No','','','','','','','Branch: Yes → 13A (q82, q83)'],
    ...
    ['q82','13A','WORKFORCE_LEAVING','Exploring Outside the Agency','What types of opportunities are you exploring outside the agency? Select all that apply.','checkbox','Y','Y','Transfer to another MA state agency|Leaving state service entirely|Private sector|Non-profit or education|Not sure yet','q81','Yes','','2','','','Max 2 selections. Only shown if Q81=Yes. Outside-agency options only.'],
