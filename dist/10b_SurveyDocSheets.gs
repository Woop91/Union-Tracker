...
function createSurveyQuestionsSheet(ss) {
  ...
  var SEED = [
    ...
    ['q80','13','WORKFORCE_RETENTION','Workforce Mobility','How likely are you to still be working at this organization one year from now?','radio','Y','Y','Very Likely|Likely|Uncertain|Unlikely|Very Unlikely','','','','','','',''],
    ['q81','13','WORKFORCE_RETENTION','Workforce Mobility','Are you currently exploring job opportunities outside of this organization?','radio-branch','Y','Y','Yes|No','','','','','','','Branch: Yes → 13A (q82, q83)'],
    ...
    ['q86','13','WORKFORCE_RETENTION','Workforce Mobility','What would most encourage you to stay at this organization? (optional)','paragraph','N','Y','','','','','','','','Optional open text'],
    // ── Section 13A: Leaving (Q81=Yes) ──────────────────────────────────
    ['q82','13A','WORKFORCE_LEAVING','Exploring Outside Opportunities','What types of opportunities are you exploring outside of this organization? Select all that apply.','checkbox','Y','Y','Transfer to another state agency|Leaving state service entirely|Private sector|Non-profit or education|Not sure yet','q81','Yes','','2','','','Max 2 selections. Only shown if Q81=Yes.'],
    ['q83','13A','WORKFORCE_LEAVING','Exploring Outside Opportunities','What are the primary reasons you are considering leaving? Select up to 3.','checkbox','Y','Y','Pay & Benefits|Workload / Caseload|Management & Supervision|Limited Advancement or Transfer Opportunities|Work-Life Balance|Return-to-Office Policy|Job Stress / Burnout|Workplace Culture|Other','q81','Yes','','3','','','Max 3 selections. Q85 transfer awareness folded into \"Limited Advancement or Transfer Opportunities\" option. Only shown if Q81=Yes']
  ];
...
function createNotificationsSheet(ss) {
  ...
  var starterRows = [
    [
      ...
      'Your SolidBase dashboard is now live! Here you can check in to meetings, learn about your rights, and track grievance progress. Contact your steward if you have any questions.',
      'Normal',
      systemEmail,
      'System',
      today,
